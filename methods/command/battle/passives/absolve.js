...
module.exports = class Absolve extends PassiveInterface{
	...
	postHealed(animal,healer,amount,tags){
		...
		let dmg = WeaponInterface.inflictDamage(animal,attacking,totalDamage,WeaponInterface.MAGICAL,{...tags,absolve:true});

		logs.push(`[ABSV] ${animal.nickname} damaged ${attacking.nickname} for ${dmg.amount} HP`,dmg.logs);
