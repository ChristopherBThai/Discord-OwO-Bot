...
module.exports = class EnergyStaff extends WeaponInterface{
	...
	init(){
		...
		this.basicDesc = "";
		this.emojis = ["<:cestaff:572983469764902912>","<:uestaff:572984069370019850>","<:restaff:572984067432382485>","<:eestaff:572983470360363018>","<:mestaff:572984069915279380>","<:lestaff:572984070007423006>","<:festaff:572984069512757249>"];
		this.defaultEmoji = "<:estaff:572983470465220608>";
		this.statDesc = "Send a wave of energy and deal **?%** of your "+WeaponInterface.magEmoji+"MAG to all opponents";
