...
module.exports = class Rune extends WeaponInterface{
	...
	init(){
		...
		this.statDesc = "Increase ALL stats by ?%, and changes your physical attacks to do 80% STR and 80% MAG as TRUE damage. This weapon does not have an active ability.";
	...
	attackPhysical(me,team,enemy){
		...
		/* Calculate damage */
		let damage = WeaponInterface.getMixedDamage(me.stats.att,.8,me.stats.mag,.8);
