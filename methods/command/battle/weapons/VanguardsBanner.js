...
module.exports = class VanguardsBanner extends WeaponInterface{
	...
	init(){
		...
		this.basicDesc = "";
		this.emojis = ["<:cvban:618001307411677195>","<:uvban:618001308355395584>","<:rvban:618001308192079873>","<:evban:618001307814461453>","<:mvban:618001308682551306>","<:lvban:618001308284354561>","<:fvban:618001308544270337>"]
		this.defaultEmoji = "<:vban:618001308837740545>";
		this.statDesc = "Buff all allies for **?%** of your "+WeaponInterface.magEmoji+"MAG and applies **Attack Up** for 2 turns. If the user has enough WP when the buff expires, the buff will be recasted with a stronger version.";
