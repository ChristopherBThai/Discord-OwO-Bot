...
async function openFabledBox(p){
	...
	let firstGem = gem.gems[Object.keys(gem.gems)[0]].gem;
	let gemName = firstGem.rank+" "+firstGem.type+" Gem";
	let text1 = blank+" **| "+p.msg.author.username+"** opens a Fabled lootbox\n"+fboxShake+" **|** and finds a ...";
	let text2 = firstGem.emoji+" **| "+p.msg.author.username+"** opens a Fabled lootbox\n"+fboxOpen+" **|** and finds a" + ((gemName.charAt(0)=='E' || gemName.charAt(0)=='U') ? "n" : "") + " **"+gemName+"**!";
