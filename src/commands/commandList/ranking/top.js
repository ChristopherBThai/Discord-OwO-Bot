...
function getRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global OwO Rankings" : "OwO Rankings for " + msg.channel.guild.name),
		function (query, rank) {
...
function getZooRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global Zoo Rankings" : "Zoo Rankings for " + msg.channel.guild.name),
		function (query, rank) {
...
function getMoneyRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global Cowoncy Rankings" : "Cowoncy Rankings for " + msg.channel.guild.name),
		function (query, rank) {
...
function getRepRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global Cookie Rankings" : "Cookie Rankings for " + msg.channel.guild.name),
		function (query, rank) {
...
function getHuntbotRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global HuntBot Rankings" : "HuntBot Rankings for " + msg.channel.guild.name),
		function (query, rank) {
...
function getLuckRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global Luck Rankings" : "Luck Rankings for " + msg.channel.guild.name),
		function (query, rank) {
...
function getCurseRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global Curse Rankings" : "Curse Rankings for " + msg.channel.guild.name),
		function (query, rank) {
			if (rank == 0) return ">\t\tLuck: " + global.toFancyNum(query.lcount) + "\n\n";
			else return "\n\t\tLuck: " + global.toFancyNum(query.lcount) + "\n";
		}
...
function getBattleRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global Battle Streak Rankings" : "Battle Streak Rankings for " + msg.channel.guild.name),
		function (query, rank) {
...
function getDailyRanking(globalRank, con, msg, count, p) {
	...
	displayRanking(con, msg, count, globalRank, sql,
		"Top " + count + " " + ((globalRank) ? "Global Daily Streak Rankings" : "Daily Streak Rankings for " + msg.channel.guild.name),
		function (query, rank) {
