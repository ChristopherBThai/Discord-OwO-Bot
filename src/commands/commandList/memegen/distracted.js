...
module.exports = new CommandInterface({
	...
	execute: function(p){
		...
		canvasUtil.loadBackground('./src/data/images/distracted.jpg',function(err,ctx,canvas,image){
			if(err){
				p.errorMsg(", Uh oh... this command broke..",3000);
				return
			}

			let textArgs = {x:500,y:170,width:200,height:200,size:30,stroke:3,align:"center",color:'black',text:args[0],imageSize:100};
