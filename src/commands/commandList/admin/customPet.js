...
const embed = {
	...
	embed: {
		...
		author: {
			...
			icon_url: "https://cdn.discordapp.com/avatars/408785106942164992/7f7a07bfad0ad6a2faaaccd9421e5392.png?size=1024"
		},
		title: "To redeem your pet, please DM **Scuttler#0001** with the info below!",
		description: "I will need these information below!\n```\n"
	}
}
embed.embed.description += "Pet Name:  The name of your pet! Duplicate pet names are not\n           allowed and must be only latin characters! Special\n           characters and spaces are not allowed.\n";
embed.embed.description += "Pet Image: The image can be any size! Keep in mind that there\n           will be a patreon logo on the top left of the\n           image.\n";
embed.embed.description += "Pet Desc:  You can add a custom description of your pet. This\n           is optional.\n";
embed.embed.description += "Pet Stats: You can distribute 20 points across\n           hp/str/pr/wp/mag/mr. All stats must be at least 1\n           point.\n```\n";
embed.embed.description += "**Here are a few rules**\n";
embed.embed.description += " - The pet must be appropriate for all ages.\n";
embed.embed.description += " - The pet cannot be a real life image and must contain at least a face.\n";
embed.embed.description += " - You can change the stats of the pet if you request it within 1 week of pet creation.\n";
