...
const emoji = "<:grizzly:858493717766078506>";
const owner = "384202884553768961";
const data = "grizzly";
const plural = "grizzlys";
...
module.exports = new CommandInterface({
	...
	desc:"Give two grizzlys to someone! You can only gain one if you receive it! This command was created by ?"+owner+"?",
...
async function give(p,user){
	...
	p.send(`${emoji} **| ${p.msg.author.username}** sent ${user.username} 2 grizzlys!`);
}
