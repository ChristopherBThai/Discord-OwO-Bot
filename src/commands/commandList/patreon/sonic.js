...
const emoji = "<a:sonic:889369004739817522>";
...
module.exports = new CommandInterface({
	...
	desc:"Give sonics to someone! You can only gain one if you receive it! This command was created by ?"+owner+"?",
...
async function give(p,user){
	...
	p.send(`${emoji} **| ${user.username}**, ${p.msg.author.username} gave you 2 sonics!`);
}
