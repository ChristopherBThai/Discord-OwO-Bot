...
async function display(p){
	...
	p.replyMsg(dishEmoji,", you currently have "+count+" dish(es) of iskender to enjoy! Eat while it's hot!");
}
...
async function give(p,user){
	...
	p.send(`${dishEmoji} **| ${user.username}**, you received two dishes of iskender from ${p.msg.author.username}! Afiyet olsun!`);
}
