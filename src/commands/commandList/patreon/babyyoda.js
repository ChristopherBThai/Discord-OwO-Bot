...
const gif1 = "https://cdn.discordapp.com/attachments/719300418055962694/825092690026168320/image0.gif";
const gif2 = "https://cdn.discordapp.com/attachments/719300418055962694/825092690621628446/image1.gif";
const gif3 = "https://cdn.discordapp.com/attachments/719300418055962694/825092691246317638/image2.gif";
const gif4 = "https://cdn.discordapp.com/attachments/719300418055962694/825092691809140816/image3.gif";
...
async function giveBall (p) {
	...
	await p.redis.hset("cd_"+p.msg.author.id, cdBall, new Date());
	await p.redis.expire("cd_"+p.msg.author.id);
	display(p, "That seems to have done the trick, he seems content. You can claim your daily streak now!", gif4);
}
