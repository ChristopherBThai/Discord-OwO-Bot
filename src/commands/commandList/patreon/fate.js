...
const giveAmount = 1;
const desc = "A fateful stone that connects People. Its glimmers can entwine their fates, just as how its glimmer links stars into the shapes of a heart's desires. No one knows where this stone comes from.";
