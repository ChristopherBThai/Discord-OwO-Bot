...
const emoji = "<a:panda:878174759353995295>";
...
module.exports = new CommandInterface({
	...
	desc:"Give a panda to someone! You can only gain one if you receive it! This command was created by ?384202884553768961?",
...
async function give(p,user){
	...
	p.send(`${emoji} **| ${user.username}**, **${p.msg.author.username}** gave you 2 pandas!`);
}
