...
module.exports = new CommandInterface({
	...
	desc:"Give two candy canes to someone! You can only gain one if you receive it! This command was created by ?"+owner+"?",
...
async function give(p,user){
	...
	p.send(`${emoji} **| ${p.msg.author.username}** sent ${user.username} 2 pink sparkly candy-canes! Enjoy!`);
}
