...
const emoji = "<:ginseng:858492778471620609>";
const owner = "384202884553768961";
const data = "ginseng";
const plural = "ginsengs";
...
module.exports = new CommandInterface({
	...
	desc:"Give two ginsengs to someone! You can only gain one if you receive it! This command was created by ?"+owner+"?",
...
async function give(p,user){
	...
	p.send(`${emoji} **| ${p.msg.author.username}** sent ${user.username} 2 ginsengs!`);
}
