...
class RedEnvelope extends Collectible {
	constructor() {
		...
		this.displayMsg = '?emoji? **| ?user?**, you currently have ?count? red envelope?plural? and ?mergeCount? gold?plural? ?mergeEmoji? ! Wishing you lots of luck!'
		this.brokeMsg = ', you do not have any Red Envelopes! >:c';
		this.giveMsg = '?emoji? **| ?receiver?**, you have received 1 Red Envelope from ?giver?! Best of luck!';

		this.hasMerge = true;
		this.mergeNeeded = 8;
		this.mergeEmoji = '<:gold:1080076845124427806>';
		this.mergeMsg = "?giveMsg?\n?blank? **|** Your eight red envelopes combined and turned into a gold! ?mergeEmoji?"
