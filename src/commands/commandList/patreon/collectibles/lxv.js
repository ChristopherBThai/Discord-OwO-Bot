...
class Lxv extends Collectible {
	constructor() {
		...
		this.displayMsg = '<:846997443278274610:1055044684382208010> **| ?user?**, you currently have ?count? ?emoji? lxv. Don\'t forget to take care of them!\n<:1039236830022868992:1055044688979185664> **|** Hedge has collected ?mergeCount? **lovesick** for you!'
		...
		this.mergeMsg = "?emoji? **|** ?user? pats Hedge. In excitement both of them dig around..\n<:1039236830022868992:1055044688979185664> **|** and they found 1 **lovesick**! ";
	...
	async getDisplayMsg(p, args, msgOverride) {
		...
		let msg = '<:847033688302551061:1055044687527948298> **| ?user?**, you currently have ?count? ?emoji? lxv. You have taken care of it for today!\n<:1039236830022868992:1055044688979185664> **|** Hedge has collected ?mergeCount? **lovesick** for you!'
		if (afterMid.after) {
			if (afterMid.withinDay) {
				msg = '<:846997443278274610:1055044684382208010> **| ?user?**, you currently have ?count? ?emoji? lxv. Don\'t forget to take care of them!\n<:1039236830022868992:1055044688979185664> **|** Hedge has collected ?mergeCount? **lovesick** for you!'
			} else {
				msg = '<:846997478246318080:1055044685153972225> **| ?user?**, you currently have ?count? ?emoji? lxv. One of them ran away because you didn\'t take care of it...\n<:1039236830022868992:1055044688979185664> **|** Hedge has collected ?mergeCount? **lovesick** for you!'
