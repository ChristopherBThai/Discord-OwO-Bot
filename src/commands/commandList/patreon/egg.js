...
const emoji = "<a:egg:965363573448663052>";
const owners = ["204118895106195456", "460987842961866762"];
const data = "egg";
const ownerOnly = true;
const giveAmount = 1;
const desc = "This item can only be sent by the creators!";
const displayMsg = `, you currently have ?count? egg?plural?.`;
const brokeMsg = `, you do not have any eggs to give! >:c`;
const giveMsg = `, you have been given 1 Egg.
`;
