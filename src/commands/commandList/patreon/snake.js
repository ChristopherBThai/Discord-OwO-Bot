...
module.exports = new CommandInterface({
	...
	desc:"Give snakes to someone! You can only gain one if you receive it! This command was created by ?"+owner+"?",
...
async function give(p,user){
	...
	p.send(`${emoji} **| ${user.username}**, ${p.msg.author.username} gave you 2 snakes!`);
}
