...
module.exports = new CommandInterface({
	...
	desc:"Give two cups of water to someone! You can only gain one if you receive it! This command was created by ?"+owner+"?",
