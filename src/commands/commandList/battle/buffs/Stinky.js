...
module.exports = class Stinky extends BuffInterface {
	init() {
		...
		this.statDesc = `Prevents any future buffs *AND* debuffs to be applied to this animal. On successly preventing a buff, deal **?%** ${WeaponInterface.magEmoji}MAG to the animal.`;
