...
module.exports = class Rune extends WeaponInterface{
	...
	init(){
		...
		this.statDesc = "Increase ALL stats by ?%, and changes your physical attacks to do 90% of your "+WeaponInterface.strEmoji+"STR and 90% of your "+WeaponInterface.magEmoji+"MAG as MIXED damage. This weapon does not have an active ability.";
	...
	attackPhysical(me,team,enemy){
		...
		/* Calculate damage */
		let damage = WeaponInterface.getMixedDamage(me.stats.att,.90,me.stats.mag,.90);
