...
module.exports = class Rune extends WeaponInterface{
	...
	init(){
		...
		this.statDesc = "Increase ALL stats by ?%, and changes your physical attacks to do 90% "+WeaponInterface.strEmoji+"STR and "+WeaponInterface.magEmoji+"MAG as MIXED damage. This weapon does not have an active ability.";
