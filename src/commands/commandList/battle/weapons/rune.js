...
module.exports = class Rune extends WeaponInterface {
	init() {
		...
		this.statDesc = stripIndents`
			Increase ALL stats by ?%, and changes your physical attacks to do 65% STR and 65% MAG as TRUE damage. 
			This weapon does not have an active ability.
		`;
