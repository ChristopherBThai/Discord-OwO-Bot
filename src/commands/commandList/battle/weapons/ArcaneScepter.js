...
module.exports = class ArcaneScepter extends WeaponInterface{
	...
	init(){
		...
		this.basicDesc = "";
		this.emojis = ["<:cascept:618001308343074826>","<:uascept:618001309005512734>","<:rascept:618001308691202059>","<:eascept:618001307994685441>","<:mascept:618001309399777281>","<:lascept:618001309773201409>","<:fascept:618001309156769793>"]
		this.defaultEmoji = "<:ascept:618001305692274698>";
		this.statDesc = "Replenish **?%** of your "+WeaponInterface.magEmoji+"MAG as "+WeaponInterface.wpEmoji+"WP to an ally with the lowest "+WeaponInterface.wpEmoji+"WP";
	...
	attackWeapon(me,team,enemy){
		...
		/* replenish ally */
		replenish = WeaponInterface.replenish(lowest,replenish,me,{me,allies:team,enemies:enemy});
		logs.push(`[ASCEPT] ${me.nickname} replenished ${replenish.amount} WP to ${lowest.nickname}`, replenish.logs);
