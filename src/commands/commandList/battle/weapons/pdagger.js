...
module.exports = class PDagger extends WeaponInterface{
	...
	init(){
		...
		this.statDesc = "Deals **?%** of your "+WeaponInterface.strEmoji+"STR to a random enemy and applies **poison** for 2 turns";
	...
	attackWeapon(me,team,enemy){
		...
		buff.bind(attacking,2,{me,allies:team,enemies:enemy});
