...
const ranks = [['common','cw','commonweapons','commonweapon'],['uncommon','uw','uncommonweapons','uncommonweapon'],['rare','rw','rareweapon','rareweapons'],
      ['epic','ew','epicweapons','epicweapon'],['mythic','mythical','mw','mythicalweapons','mythicalweapon','mythicweapons','mythicweapon'],
      ['legendary','lw','legendaryweapons','legendaryweapon'],['fabled','fable','fw','fabledweapons','fabledweapon','fableweapons','fableweapon']];
